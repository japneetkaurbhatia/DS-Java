/* 1. Flood Fill without Jump
   2. Flood Fill with Jump 
   3. Knight Tour */

import java.util.Scanner;

public class floodFillIntro{
    ...
    public static int floodFillJump(int sr, int sc, int er, int ec, boolean[][] vis, int[][] dir, String[] dirS, String ans){
        ...
        for(int rad = 0; rad < Math.max(n,m); rad++){  //Math.max handles the rectangle shaped matrix too
        for(int d = 0; d < dir.length; d++){
